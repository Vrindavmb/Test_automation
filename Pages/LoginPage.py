...
class LoginPage(BasePage):
    ...
    def enter_email_address(self,email_address_text):
        self.type_into_a_element(email_address_text,"email_address_field_id",self.email_address_field_id)

    def enter_password(self,password_text):
        self.type_into_a_element(password_text,"password_field_id",self.password_field_id)
    ...
    def retrieve_warning_message(self):
        self.retreive_element_text("warning_message_xpath",self.warning_message_xpath)
