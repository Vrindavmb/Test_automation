...
class RegisterPage(BasePage):
    ...
    def enter_first_name(self, first_name_text):
        self.type_into_a_element(first_name_text, "first_name_field_id", self.first_name_field_id)

    def enter_last_name(self, last_name_text):
        self.type_into_a_element(last_name_text, "last_name_field_id", self.last_name_field_id)

    def enter_email(self, email_text):
        self.type_into_a_element(email_text, "email_field_id", self.email_field_id)

    def enter_telephone(self, telephone):
        self.type_into_a_element(telephone, "telephone_field_id", self.telephone_field_id)

    def enter_password(self, password):
        self.type_into_a_element(password, "password_field_id", self.password_field_id)

    def enter_password_confirm(self, confirmpassword):
        self.type_into_a_element(confirmpassword, "confirm_password_field_id", self.confirm_password_field_id)
    ...
    def register_an_account(self, first_name_text, last_name_text, email_text, telephone, password, confirmpassword,
        ...
        self.enter_password_confirm(confirmpassword)
    ...
    def retrieve_duplicate_email_warning(self):
        return self.retreive_element_text("duplicate_email_warning_xpath", self.duplicate_email_warning_xpath)

    def retrieve_privacy_policy_warning(self):
        return self.retreive_element_text("privacy_policy_warning_xpath", self.privacy_policy_warning_xpath)

    def retrieve_first_name_warning(self):
        return self.retreive_element_text("firstname_warning_xpath", self.firstname_warning_xpath)
    ...
    def verify_all_warnings(self, expected_privacy_policy_warning_message, expected_firstname_warning_message,
        ...
        if expected_privacy_policy_warning_message.__contains__(actual_privacy_policy_warning_message):
            if expected_firstname_warning_message.__eq__(actual_first_name_warning_message):
                if expected_lastname_warning_message.__eq__(actual_last_name_warning_message):
